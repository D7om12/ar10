...
ki2= ARIFISTIFIK.LINE()
ki2.login(token="token")
ki2.loginResult()

ki3 = ARIFISTIFIK.LINE()
ki3.login(token="token")
ki3.loginResult()

ki4 = ARIFISTIFIK.LINE()
ki4.login(token="token")
ki4.loginResult()

ki5 = ARIFISTIFIK.LINE()
ki5.login(token="token")
ki5.loginResult()

ki6 = ARIFISTIFIK.LINE()
ki6.login(token="token")
ki6.loginResult()

ki7 = ARIFISTIFIK.LINE()
ki7.login(token="token")
ki7.loginResult()

ki8 = ARIFISTIFIK.LINE()
ki8.login(token="token")
ki8.loginResult()

ki9 = ARIFISTIFIK.LINE()
ki9.login(token="token")
ki9.loginResult()

ki10 = ARIFISTIFIK.LINE() #Ghost
...
╚═══「 ǞЯiբisƮiբiκ」═══╝
"""
KAC=[arif,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10]
DEF=[arif,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9,ki10]
...
Bots=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,ki10mid,Smid,"u65224f4e8812136f01b25275a54b5aef"]
admin=[mid,kimid,ki2mid,ki3mid,ki4mid,ki5mid,ki6mid,ki7mid,ki8mid,ki9mid,Smid,"u65224f4e8812136f01b25275a54b5aef","ue4e13b0a41d848845489374e671c6861","ub21eb3d440e0dfd640eef9f2fb5ce02d","u782cdf7a9fd2545c84a0cd86f418e9f7","u799da4e06d50e1775cfcff1f3e59df03"]
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if not target in Bots:
                            try:
                                klist=[arif,ki,ki2,ki3,ki4,ki5,ki6,ki7,ki8,ki9]
                                kicker=random.choice(klist)
                                kicker.kickoutFromGroup(msg.to,[target])
                                print (msg.to,[g.mid])
                            except:
